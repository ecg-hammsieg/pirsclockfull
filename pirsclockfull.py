...
ind1y          = int((ycenter*1.2)-(indboxy/2))
...
ind1txt       = indfont.render("ON AIR",True,ind1colour)

# Indicator positions
txtposind1 = ind1txt.get_rect(centerx=xtxtpos,centery=ycenter*0.2)
...
while True :
    ...
    #Aufgabe: Youtube Livestream implementieren
